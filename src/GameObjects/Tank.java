...
public class Tank extends GameObject {
    ...
    public Tank(float x, float y, float vx, float vy, float angle, BufferedImage img, int id, GameWorld gw) {
        super(x,y,img);
        this.vx = vx;
        this.vy = vy;
        this.angle = angle;
    ...
    private void respawnTank(GameWorld gw) {
        ...
        } while (!isValidRespawnPosition(respawnX, respawnY));
    ...
    private boolean isValidRespawnPosition(float x, float y) {
        ...
        for (GameObject obj : gw.getGameObjects()) {
